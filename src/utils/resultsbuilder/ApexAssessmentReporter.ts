  ...
  private static getRowsForReport(apexAssessmentInfos: ApexAssessmentInfo[]): ReportRowParam[] {
    return apexAssessmentInfos.map((apexAssessmentInfo) => ({
      ...
      data: [
        ...
        createRowDataParam('diff', apexAssessmentInfo.name+'diff', false, 1, 1, false, undefined, FileDiffUtil.getDiffHTML(apexAssessmentInfo.diff, apexAssessmentInfo.name)),
        createRowDataParam(
          'comments',
